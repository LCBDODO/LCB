...
<div class="lcb-page">
  <section class="lcb-section">
    <h1 class="lcb-section-title">Research</h1>
    <p class="lcb-section-lead">
      We are wholly dedicated to acquiring a better understanding of the mechanisms of cancer drug resistance in order to vastly improve patient survival and quality of life.
    </p>
  </section>

  <section class="lcb-section compact">
    <h2 class="lcb-section-title">Research Topics</h2>
    <div class="lcb-card-grid">
      <div class="lcb-card"><h3>Identifying vulnerability of cancer cells</h3><p>Discovery of cancer-selective vulnerabilities and therapeutic dependencies.</p></div>
      <div class="lcb-card"><h3>Epigenetic mechanism for immune evasion</h3><p>Understanding how malignant cells remodel immune recognition and tumor immunity.</p></div>
      <div class="lcb-card"><h3>Oncogenic metabolites</h3><p>Discovering metabolites and metabolic states that support cancer progression and therapy resistance.</p></div>
      <div class="lcb-card"><h3>Novel immunotherapy modalities</h3><p>Exploring translational strategies including TIL-based approaches and cancer vaccines.</p></div>
    </div>
  </section>
